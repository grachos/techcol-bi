...
export function Dashboard() {
  ...
  const topNav = topNavKeys.map((item) => ({ ...item, title: t(item.title) }))
  return (
    <>
      {/* ===== Top Heading ===== */}
      <Header>
            ...
            <div className='grid grid-cols-1 gap-4 lg:grid-cols-7'>
              ...
              <Card className='col-span-1 lg:col-span-3'>
                <CardHeader>
                  ...
                  <CardDescription>
                    {t('You made {{total}} sales this month.', { total: 265 })}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <RecentSales />
