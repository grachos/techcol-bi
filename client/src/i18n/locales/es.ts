...
export const es: Record<string, string> = {
  ...
  'One representative record with all its columns; repeated rows are collapsed. The data path is the key holding the list of rows.':
    'Un registro representativo con todas sus columnas; las filas repetidas se colapsan. La ruta de datos es la clave que contiene la lista de filas.',
